...
| Operational guardrails | Artefact, terminology, frontend-source and browser-bundle guards reduce accidental leakage of local specs, public wording drift, internal URLs and backend-only settings. | [quality guards](../scripts/quality-guards.mjs), [release quality checks](release-runbook.md#release-quality-checks). |
...
1. Pull request gate:
   ...
   - run artefact, terminology and frontend-source guards;
